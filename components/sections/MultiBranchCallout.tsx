...
export default function MultiBranchCallout() {
  return (
    <section className="py-14 md:py-20 bg-gradient-to-br from-brand-600 to-brand-600">
      <div className="max-w-4xl mx-auto px-5 sm:px-6 text-center">
        ...
        <p className="text-brand-100 text-base sm:text-lg max-w-xl mx-auto leading-relaxed mb-8 sm:mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <Link
            href="/contact"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white text-brand-700 font-semibold hover:bg-brand-50 transition-colors shadow-lg text-sm"
          >
