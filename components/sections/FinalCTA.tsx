  ...
  return (
    <section className="py-16 md:py-24 bg-slate-900">
      <div className="max-w-3xl mx-auto px-5 sm:px-6 text-center">
        <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-brand-500/10 border border-brand-500/20 mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <Link
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-brand-500 text-white font-semibold hover:bg-brand-400 transition-colors shadow-lg shadow-brand-500/25 text-sm"
          >
            Start Free Trial
            <ArrowRight size={15} />
          </Link>
