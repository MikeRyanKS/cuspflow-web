---
title: Branches & dental chairs
description: Set up multiple locations and their dental chairs, with per-branch schedules, availability and live chair occupancy.
category: operations
order: 3
updated: 2026-07-21
---

CuspFlow supports clinics of any size, from a single room to a network of locations. Branches and chairs are configured under **Settings → Branches & Chairs**.

## Branches

Each **branch** is a physical location. A branch keeps its own:

- Dental chairs
- Staff schedules and availability
- Inventory levels

Single-location clinics simply use the one main branch created at signup.
