...
Most list and report pages have an **Export CSV** button for staff with the right [permission](/docs/core-concepts/roles-and-permissions), so you can take data into a spreadsheet for your own analysis or records.
