---
title: Choosing & managing your subscription
...
| Plan | Staff seats | Imaging storage | Monthly | Annual |
|---|---|---|---|---|
...
- Watch **usage meters** for seats and storage.
- **Change plan** or switch between monthly and annual billing.
- Adjust **add-on** quantities.
- View and download your **invoice history**.
- Enter a **promo code**.
- Open the secure billing portal to **manage your card details**.
