      ...
      <main className="pt-16 sm:pt-24">
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-white via-brand-50/40 to-brand-50/60">
          <div className="max-w-3xl mx-auto px-5 sm:px-6 text-center">
            <p className="text-sm font-semibold text-brand-600 uppercase tracking-wider mb-4">Pricing</p>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-4xl mx-auto px-5 sm:px-6">
            <div className="text-center mb-8 md:mb-10">
              <p className="text-sm font-semibold text-brand-600 uppercase tracking-wider mb-3">Add-ons</p>
            ...
            <div className="space-y-3">
              {addons.map((a) => (
                <div key={a.name} className="flex items-center justify-between gap-4 bg-slate-50 rounded-xl border border-slate-100 p-4 sm:p-5">
                  ...
                  <span className="text-sm font-bold text-brand-600 shrink-0">{a.price}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-12 md:py-16 bg-slate-50/60">
          <div className="max-w-3xl mx-auto px-5 sm:px-6">
            ...
            <p className="text-center text-sm text-slate-500 mt-8">
              ...
              <Link href="/docs/reference/faq" className="text-brand-600 font-medium hover:text-brand-700">
                Read the full FAQ
              </Link>{" "}
              or browse the{" "}
              <Link href="/docs" className="text-brand-600 font-medium hover:text-brand-700">
                documentation
              </Link>
              .
            </p>
        ...
        <section className="py-12 md:py-16 bg-white border-t border-slate-100">
          <div className="max-w-xl mx-auto px-5 sm:px-6 text-center">
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-600 text-white font-semibold hover:bg-brand-700 transition-colors text-sm">
